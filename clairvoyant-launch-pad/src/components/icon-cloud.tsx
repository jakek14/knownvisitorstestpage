...
export default function IconCloudDemo() {
  const iconImages = [
    ...
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/tiktok.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/snapchat.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/pinterest.svg",
    ...
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/amazonwebservices.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/amazon.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/shopify.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/wix.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/squarespace.svg",
    "https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/bigcommerce.svg",
  ];
